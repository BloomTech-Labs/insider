  ...
  render() {
    return (
      <div className ="message-col">
        ...
        />
        <h6> Message </h6>
        <input name="message"className = "message-form form-control" onChange={this.handleInput} placeholder="text" />

 
        <StripeProvider apiKey="pk_test_N3kloqdrQMet0yDqnXGzsxR0">
          <Checkout message={this.state.message} recipient={this.state.recipient} updateParentState={this.props.updateParentState}/>
        </StripeProvider>
